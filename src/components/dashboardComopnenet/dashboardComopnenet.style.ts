...
import { Buttons, PrimaryComponent, Version } from '../../style/themes.style';
...
export const DisplayUsersContainer = styled.div<{ $isWide?: boolean }>`
  ...
  background-color: ${({ theme }) => theme.primaryComponent[Version.chosen].backgroundColor};
  border: 1px solid ${({ theme }) => theme.primaryComponent[Version.chosen].borderColor};
...
`;
export const DisplayUsersBrowserEditionRow = styled.tr<{ $odd?: boolean; $isHeader?: boolean }>`
...
export const DisplayUserMobileEdition = styled.div<{ $isChoosen: boolean }>`
  color: ${({ theme, $isChoosen }) =>
    theme.secondaryComponentV1[$isChoosen ? Version.chosen : Version.notChosen].color};
  background-color: ${({ theme, $isChoosen }) =>
    theme.secondaryComponentV1[$isChoosen ? Version.chosen : Version.notChosen].backgroundColor};
  border-color: ${({ theme, $isChoosen }) =>
    theme.secondaryComponentV1[$isChoosen ? Version.chosen : Version.notChosen].borderColor};
